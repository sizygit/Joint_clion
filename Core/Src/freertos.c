...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of Joint */
  osThreadDef(Joint, Joint_Task, osPriorityIdle, 0, 128);
  JointHandle = osThreadCreate(osThread(Joint), NULL);
...
__weak void Joint_Task(void const * argument)
{
